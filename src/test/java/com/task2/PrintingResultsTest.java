...
//
//        ArrayList<Double> multiplier = dataProcessing.getArrayList(1, 2, 1);
...
//
//        ArrayList<Double> multiplier = dataProcessing.getArrayList(400.5, 500.5, 50.5);
//        String result = printingResults.printResults(multiplier, outputFormat);
...
//
//        ArrayList<Double> multiplier = dataProcessing.getArrayList(1100, 2200, 1100);
//        String result = printingResults.printResults(multiplier, outputFormat);
...
//
//        ArrayList<Double> multiplier = dataProcessing.getArrayList(1.25, 2.00, 0.50f);
//        String result = printingResults.printResults(multiplier, outputFormat);
//        String expectedResult = "\n1.25 * 1.25 = 1.563\n1.25 * 1.75 = 2.188\n" +
//                "1.75 * 1.25 = 2.188\n1.75 * 1.75 = 3.063";
//
